...
log_dir=$BASE/code/trekker/logs && mkdir -p ${log_dir}
...
#for sub in $(cat ${sub_list}); do
	...
	# Run trekker
	log_output=$BASE/code/trekker/logs/${sub}_trekker_job-%j.o
	log_error=$BASE/code/trekker/logs/${sub}_trekker_job-%j.e
