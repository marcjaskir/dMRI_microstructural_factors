...
from lib.paths import project_root, data_dir, derivatives_dir, results_dir, inclusion_dir
...
MNI_MICRO_PROJECT_ROOT = f"{PROJECT_ROOT}/derivatives/gam/mni_micro"
GM_GLASSER_PROFILE_DIR = f"{MNI_MICRO_PROJECT_ROOT}/Glasser"
GM_4S156_PROFILE_DIR = f"{MNI_MICRO_PROJECT_ROOT}/4S156"
WM_PROFILE_DIR_PYAFQ = f"{PROJECT_ROOT}/derivatives/gam/pyafq/HCP1065"
...
OUTPUT_PROJECT_ROOT = f"{PROJECT_ROOT}/derivatives/analysis/factor_z-scores"
...
CONTROLS_SUBJECTS_INCLUDED_PATH = f"{PROJECT_ROOT}/derivatives/analysis/factor_analysis/subjects_included.csv"
