...
<body>
  ...
  """ + atlas_tables + """
  <h2>Subgroups</h2>
  <p><a href="subgroup_correlation_matrices.html">Left and right TLE correlation matrices</a> by tissue group (Glasser cortex, 4S subcortex, 4S cortex, association WM, projection WM). Subject × subject correlation of asymmetry profiles with hierarchical clustering; sub-RIDs on axes.</p>
