...
Demographics/scanner covariates required to recompute CovBat/GAM are not
shipped (patient privacy); manuscript reproduction uses `data/open/` only.
...
- `workspace_root`, `code_dir`, `data_open_dir`
- `gam_dir`, `analysis_dir`, `atlas_dir`, `inclusion_dir`, `open_metadata_dir`
- optional controlled_* keys (unused for open manuscript reproduction)
