...
def main():
    ...
    mask_dir = f"{project_root()}/data/atlases/HCP1065/endpoint_gii"
    surf_dir = ff"{project_root()}/derivatives/freesurfer/{group}"
    output_dir = ff"{project_root()}/derivatives/freesurfer_post/{group}"
