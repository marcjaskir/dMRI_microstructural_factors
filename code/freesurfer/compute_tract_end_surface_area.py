...
gii_dir = f"{project_root()}/data/atlases/HCP1065/endpoint_gii"
output_csv = f"{project_root()}/derivatives/freesurfer_post/HCP1065_tract_end_surface_area.csv"
output_csv_ipsi = f"{project_root()}/derivatives/freesurfer_post/HCP1065_tract_end_surface_area_ipsi.csv"

# Reference surface files (fsaverage, 164k)
lh_surf = f"{project_root()}/code/tract_to_region/tpl-fsaverage_den-164k_hemi-L_white.surf.gii"
rh_surf = f"{project_root()}/code/tract_to_region/tpl-fsaverage_den-164k_hemi-R_white.surf.gii"
