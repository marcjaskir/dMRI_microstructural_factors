...
if __name__ == "__main__":
    cohort_file = f"{project_root()}/derivatives/metadata/subjects_penn_epilepsy.csv"
    redcap_file = f"{project_root()}/data/metadata/clinical_redcap.csv"
    output_file = f"{project_root()}/derivatives/metadata/clinical_penn_epilepsy.csv"
