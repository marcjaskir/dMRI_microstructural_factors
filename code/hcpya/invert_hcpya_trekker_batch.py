...
subjects_dir = f"{project_root()}/derivatives/qsirecon/hcpya"

# Path to the CSV listing already included subjects (to be excluded)
exclude_csv = f"{project_root()}/derivatives/metadata/hcp_dwi_trekker_batch-1_hcpya_subjects.csv"

# Path to write the new inverse list
output_csv = f"{project_root()}/derivatives/metadata/hcp_dwi_trekker_batch-1_hcpya_subjects-inv.csv"
