...
pyafq_dir = "{project_root()}/derivatives/pyafq"

# Specify covbat (output) directory
covbat_base_dir = "{project_root()}/derivatives/covbat/inputs/pyafq"
if not os.path.exists(covbat_base_dir):
    os.makedirs(covbat_base_dir)

# Demographic files
hcpya_demo_path = "{project_root()}/derivatives/metadata/demo_hcpya.csv"
hcpaging_demo_path = "{project_root()}/derivatives/metadata/demo_hcpaging.csv"
penn_controls_demo_path = "{project_root()}/derivatives/metadata/demo_penn_controls.csv"
penn_epilepsy_demo_path = "{project_root()}/derivatives/metadata/demo_penn_epilepsy.csv"
...
# Scanner files
hcpya_scanner_path = "{project_root()}/derivatives/metadata/scanner_ids_hcpya.csv"
hcpaging_scanner_path = "{project_root()}/derivatives/metadata/scanner_ids_hcpaging.csv"
penn_scanner_path = "{project_root()}/derivatives/metadata/scanner_ids_penn.csv"
...
# Measures files
measures_json_path = "{project_root()}/data/metadata/scalar_labels_to_filenames.json"

# Load in bundleseg json
bundleseg_json_path = "{project_root()}/code/bundleseg/config/config_HCP1065_association_projection.json"

# Specify output base directory
output_base_dir = f"{project_root()}/derivatives/covbat/inputs/pyafq/{wm_atlas}"
