...
GM_PATH = "{project_root()}/data/atlases/MNI/tpl-MNI152NLin2009cAsym_res-1mm_label-gm_probseg.nii.gz"
WM_PATH = "{project_root()}/data/atlases/MNI/tpl-MNI152NLin2009cAsym_res-1mm_label-wm_probseg.nii.gz"
...
plt.tight_layout()
plt.savefig("{project_root()}/code/atlases/tissue_mask_threshold_plot.png", dpi=150)
plt.show()
